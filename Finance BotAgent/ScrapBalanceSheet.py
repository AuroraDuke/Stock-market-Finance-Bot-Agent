...
def scrap (name):
    url = f"https://fintables.com/sirketler/{name}/finansal-tablolar/bilanco"
    ...
    arrtable = []
    for i in table: # genel tabloyu çeker 
        text = i.get_text()
    ...
    matrix_table = [headerLine] + matrix_table # listenin başına headerı ekler
    save_name = f"{name}_balance_sheet"
